    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favorite', models.ManyToManyField(related_name='favorites_boards', to='users.User')),
                ('members', models.ManyToManyField(related_name='members', to='users.User')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='boards', to='users.User')),
            ],
        ),
    ]
